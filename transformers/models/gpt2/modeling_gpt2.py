...
# Single Adapter FROM ADAPTER-HUB
class Adapter(nn.Module):
    ...
    def __init__(
        ...
        seq_list.append(nn.Linear(self.down_sample, self.input_size))
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        softmax = nn.Softmax(self.linear(hidden_states))     
        
        for n,adapter in enumerate(self.adapters):
            residual = residual + adapter(hidden_states) * softmax[n]
